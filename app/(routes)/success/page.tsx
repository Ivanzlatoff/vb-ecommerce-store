    ...
    return (
      <div className='p-10'>
        <div className='flex justify-center mt-20 items-center'>
            ...
            <h1 className='text-5xl font-bold'>Дякуємо за замовлення!</h1>
        </div>
        <div className='mt-10'>
            <h2 className='text-4xl text-center'>Будьласка, перевірте вашу електронну пошту</h2>
            <div className='text-3xl text-center my-10'>
                <h3>Якщо у вас є якісь питання, будьласка, надішліть нам листа за електронною поштою нижче:</h3>
        ...
        <div>
            <div className='text-3xl text-center'>
                ...
                : `Ваш замовлення в процесі приготування`}
            </div>
